  ...
  return (
    ...
    >
      <div className="fixed bottom-0 left-0 w-full h-screen min-h-[640px] flex flex-col justify-between">
        <section className="relative isolate w-full h-full bg-black text-white px-6 sm:px-10 md:px-14 pt-10 sm:pt-14 md:pt-16 pb-5 sm:pb-7 flex flex-col justify-between select-none overflow-hidden">
          ...
          <div className="relative z-10 w-full flex flex-col md:flex-row md:items-start justify-between gap-6 shrink-0 mt-5">
            {/* Left Headline */}
          ...
          <div className="relative w-full flex items-center justify-center pointer-events-none select-none my-auto mt-33">
            <h1
